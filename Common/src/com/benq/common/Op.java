...
public class Op {
    ...
    public static class Integral implements MathOp {
        private static final long serialVersionUID = 1L;
        private final double n1;
        private final int n2;

        public Integral(double n1, int n2) {
            this.n1 = n1;
            this.n2 = n2;
        }
    ...
    public static class IntegralResult implements MathResult {
        private static final long serialVersionUID = 1L;
        private final double n1;
        private final int n2;
        private final double result;

        public IntegralResult(double n1, int n2, double result) {
            this.n1 = n1;
            this.n2 = n2;
            this.result = result;
        }
